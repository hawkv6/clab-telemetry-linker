...
func NewDefaultPublisher(kafkaBroker, kafkaTopic string, msgChan chan consumer.Message) *DefaultPublisher {
...
func (publisher *DefaultPublisher) Init() error {
...
func (publisher *DefaultPublisher) createEncoder(msg consumer.TelemetryMessage) lineprotocol.Encoder {
...
func (publisher *DefaultPublisher) encodeTags(enc *lineprotocol.Encoder, tags consumer.MessageTags) {
...
func (publisher *DefaultPublisher) encodeDelayMessage(msg consumer.DelayMessage) (error, []byte) {
...
func (publisher *DefaultPublisher) encodeLossMessage(msg consumer.LossMessage) (error, []byte) {
	enc := publisher.createEncoder(msg.TelemetryMessage)
	publisher.encodeTags(&enc, msg.Tags)
...
func (publisher *DefaultPublisher) encodeBandwidthMessage(msg consumer.BandwidthMessage) (error, []byte) {
	enc := publisher.createEncoder(msg.TelemetryMessage)
	publisher.encodeTags(&enc, msg.Tags)
...
func (publisher *DefaultPublisher) encodeMessage(msg consumer.Message) (error, []byte) {
	switch msg := msg.(type) {
...
func (publisher *DefaultPublisher) publishMessage(msg consumer.Message) {
...
func (publisher *DefaultPublisher) Start() {
...
func (publisher *DefaultPublisher) Stop() error {
